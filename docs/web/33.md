...
> - cloudscope-cli init -tp /Users/liugezhou/Documents/imoocCourse/Web前端架构师/cloudscope-cli/commands/init/  【这里需要注意的是，由于我本读安装且默认设置了node的版本为14，而之前开发的本地脚手架为12.16，因此支持以上代码需要更换node版本】
...
> - code .
> - npm run build:demo
> - cloudscope-cli publish -tp /Users/liugezhou/Documents/imoocCourse/Web前端架构师/cloudscope-cli/commands/publish/  [不加prod属性，不用关心OSS与NPM发布]
> 
> 检查：
